🏨 Hotel Transaction Dashboard (Excel Project)
📌 Overview

This project is an interactive Hotel Transaction Dashboard built using Microsoft Excel. It provides a comprehensive analysis of hotel performance, customer behavior, and revenue insights through dynamic visualizations and KPIs.

The dashboard helps in transforming raw transactional data into meaningful insights that support better business decision-making.
